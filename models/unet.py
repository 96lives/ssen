# We use the unet deisgned by Chris Choy (chrischoy@ai.stanford.edu).
# The original code is on https://github.com/StanfordVL/MinkowskiEngine/blob/master/examples/minkunet.py

import MinkowskiEngine as ME
import torch.nn as nn
from models.modules.common import ConvType, NormType, conv, conv_tr, get_norm
...
class Res16UNetBase(MinkowskiNetwork):
	...
	def __init__(self, in_channels, out_channels, conv1_kernel_size, D=3):
	...
	def _make_layer(
			...
			stride=1, dilation=1, norm_type=NormType.BATCH_NORM, bn_momentum=0.1
	):
		downsample = None
